# Updated Agent System Instructions for Omnichannel + Sales OS

Copy and paste the following block into your OpenAI Agent Builder's "Instructions" section. This merges the NotebookLM Brain, Omnichannel capabilities, and Sales OS tools.
